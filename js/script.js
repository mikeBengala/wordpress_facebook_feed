                            ...
                            '<div class="gfn_fb_feed_post item">'	+
                                '<a href="'+ post.permalink_url +'" target="_blank">'   +
                                    '<div class="gfn_fb_post_inner_content">'   +
                                        ...
                                        '<small class="gfn_fb_feed_time">'+ date_str  +'</small>'   +
                                    '</div>'  +
                                    '<div class="gfn_fb_feed_picture_wrap"><img src="'+ post.full_picture +'" alt="picture from facebook"></div>'   +
                                    '<div class="gfn_fb_post_inner_content">'   +
